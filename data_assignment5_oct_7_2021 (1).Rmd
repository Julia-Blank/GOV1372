...
```{r}
modsoc <- lm(Social ~ BFI_extraversion + BFI_agreeableness + BFI_conscientiousness + BFI_emot_stability + BFI_openness, data = personality_data)
modec <- lm(Economic ~ BFI_extraversion + BFI_agreeableness + BFI_conscientiousness + BFI_emot_stability + BFI_openness, data = personality_data)
modover <- lm(Overall ~ BFI_extraversion + BFI_agreeableness + BFI_conscientiousness + BFI_emot_stability + BFI_openness, data = personality_data)

tab_model(modsoc, modec, modover)
